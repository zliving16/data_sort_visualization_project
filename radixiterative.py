...
def radix(some_list, idex=None, size=None):
    ...
    if idex == None:
        idex = size
        print('if idex is equal to none idex=size idex= ', idex)
    ...
    for e in some_list:
        ...
        dest_i = int(dest_c) 
        # print('dest i is equal to int dest c  dest i= ',dest_i,' e= ', e)
        bins[dest_i] += [e]
        print('bins[dest_i]= ',bins[dest_i],' e= ')
        # print('for e in some list ', some_list,' at e= ', e)
        # print ('e= ', e , 'in some list')
        print('bins= ',bins,' at e= ', e)
        # print('for sublist in some list ' , some_list ,' at sub list= ', sub_list,' and new list= ',new_list)
    ...
    for b in bins:
        ...
        print('result at b is result= ',result,'b is equal to b=',b,' idex= ',idex,' size= ', size, ' and bins= ', bins)
